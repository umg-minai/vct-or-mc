...
points(agcs$median.duration, agcs$mean.flow, pch = 19)
#title(main = "", col.main = "#808080", adj = 0L)
title(xlab = "MEDIANE ANÄSTHESIEDAUER [min]", adj = 0L, col.lab = "#808080")
title(ylab = "MITTLERER FRISCHGASFLUS [l/min]", adj = 1L, col.lab = "#808080")
