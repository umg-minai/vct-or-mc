...
Praxisnahme Daten zur Effizienz von CONTRAfluran für Sevofluran, dem klimafreundlichsten (trotz 140 CO~2~-Äquivalenten [@Nielsen2024]) volatilem Anästhetikum, sowie dessen Abhängigkeit vom Frischgasfluss und der Narkosedauer ist von entscheidender Bedeutung für die Beurteilung dieser Methode und für die Bereitschaft sie einzusetzen.
...
- MINFLOW-SHORT: medianer Frischgasfluss <= 0.5 l/min und mediane Narkosedauer <= 1 Stunde
- MINFLOW-LONG: medianer Frischgasfluss <= 0.5 l/min und mediane Narkosedauer > 1 Stunde
- LOWFLOW-SHORT: medianer Frischgasfluss > 0.5 l/min und mediane Narkosedauer <= 1 Stunde
- LOWFLOW-LONG: medianer Frischgasfluss > 0.5 l/min und mediane Narkosedauer > 1 Stunde
...
- SHORT: mediane Narkosedauer <= 1 Stunden
- LONG: median Narkosedauer > 1 Stunden
...
In Abhängigkeit von der Anzahl gewonnener Filter wird geprüft, ob für die Art
des Atemweges oder Laparoskopien vergleichbare Gruppen gebildet werden können.
