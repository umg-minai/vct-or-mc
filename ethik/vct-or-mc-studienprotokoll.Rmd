...
+----------------+--------------+------------+------------+---------------------+----------------------------------------------------------+----------------------+-----------------+
| CONTRAfluranID | SevofluranID | Datum      | Tagespunkt | Inhalative Narkose? | Dauer Narkose  Öffnung Vapor - Extubation (min)          | Mittlere FGF (l/min) | Kommentar       |
+================+==============+============+============+=====================+==========================================================+======================+=================+
| 1              |  1           | 01.06.2024 | 1          | ja                  | 60                                                       | 0.5                  |                 |
+----------------+--------------+------------+------------+---------------------+---------------------------------------------------------------------------------+-----------------+
| 1              |  1           | 01.06.2024 | 2          | nein                | 95                                                       | 0.5                  |                 |
+----------------+--------------+------------+------------+---------------------+---------------------------------------------------------------------------------+-----------------+
| ...            |  ...         | ...        | ...        | ...                 | 35                                                       | ...                  |                 |
+----------------+--------------+------------+------------+---------------------+---------------------------------------------------------------------------------+-----------------+
| 1              |  2           | 10.06.2024 | 1          | ja                  | 245                                                      | 0.5                  | Flaschenwechsel |
+----------------+--------------+------------+------------+---------------------+----------------------------------------------------------+----------------------+-----------------+
...
geschickt.
Dort wird für jede Gruppe ein bzw. mehrere separate Recyclingprozesse durchgeführt und die
